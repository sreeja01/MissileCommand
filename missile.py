...
while bases:
    ...
    for x in range(5 + round_num * 2 + int(1.13 ** round_num)):
    ...
    for t in range(end_frame):
        ...
        for m in missiles[:]:
            ...
            if dist(m.pos, m.dest) < 5:
                ...
                m.alive = 0
                for target in [Point(250 + 100 * x, 600) for x in range(6)]:
        ...
        clock.tick(30)
        pygame.display.flip()
        text(titlefont, "Game Over", (250, 200), (x, x, x))
...
bisect.insort(scores, (score, input('Enter your name: ')))
print('High Scores:\n')
